			...
			<Container>
				<Row className="py-4">
					<Col md={6} className="py-5">
						<h2>
							Best <span className="text-primary"> Wash & Iron service </span> <br /> in Durganagr
						</h2>
						<p className="text-justify my-3">
							Manolok Laundry is the first laundry service in Rabindra Sarani Durganagar. This services combine expertise and experience gained over time to deliver clean laundry in the shortest possible time.
						</p>
						<Link to="/services">
