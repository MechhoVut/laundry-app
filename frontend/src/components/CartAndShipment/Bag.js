							...
							<form onSubmit={handleSubmit(onSubmit)} className="py-2">
								<div>
									...
									<span className="from-text">
										The courier will arrive at the destination within approximately 30 minutes.
									</span>
								</div>
								...
								<div>
									...
									<span className="from-text">The courier will arrive at the address provided below.</span>
								</div>
								...
								<div className="mt-4 mb-3">
									...
									<span className="from-text">The courier will arrive at the address provided above.</span>
								</div>
